...
class PendetaController extends Controller
{
    ...
    function detailstatistik($name){
        if($name == "Jumlah+Keluarga"){
            ...
            $jemaat = Jemaat::where('status_gereja', '!=', 'Aktif')->get();
            return view('Pendeta.datajemaattidakaktif', [
            "jemaats" => $jemaat
        ]);
    ...
    function datakeluargatidakaktif(Request $request)
    {
        // Change this pagination if you want to increase pagination
        $keluarga = Keluarga::with('sektor')->where('status', '!=', 'Aktif')->get();
        return view('Pendeta.datakeluargatidakaktif', [
            "keluargas" => $keluarga
        ]);
    }
    ...
    {
        $sektors = Sektor::get();
        return view("Pendeta.formkeluarga", ['sektors' => $sektors]);
    }
    ...
    public function keluargabaru($no_kk, $id)
    {
        ...
        return view('Pendeta.formkeluargabaru', compact('keluarga', 'no_kk', 'jemaat'));
    }
    ...
    public function editdatakeluarga(Request $request, $id)
    {
        ...
        $sektors = Sektor::get();
        $lampiran = explode("#", $keluarga['lampiran']);
        return view('Pendeta.editdatakeluarga', ["keluarga" => $keluarga, 'lampiran' => $lampiran, 'sektors' => $sektors]);
    }
    public function update(Request $request, $id)
{
    ...
    if ($newData == $currentData) {
        return redirect()->route('pendeta.datakeluarga')->with('warning', 'Tidak ada perubahan pada data Keluarga!');
    ...
    function datajemaatulangtahun()
{
    ...
    return view('Pendeta.ulangtahun', [
    ...
    function formjemaat(Request $request, $idKeluarga)
    {
        ...
        return view('Pendeta.formjemaat', ['keluarga' => $keluarga]);
    }
...
public function formjemaatprocess(Request $request, $idKeluarga)
{
    ...
    function detailjemaat($nik)
    {
        ...
        return view('Pendeta.detailjemaat', [
            'jemaat' => $jemaat,
            'lampiran' => $lampiran,
            'baptis' => $baptis,
            'sidi' => $sidi,
    ...
    function editdetailjemaat2($idKeluarga,$nik)
    {
        ...
        $file_surat_baptis = $baptis ? explode("#", $baptis['file_surat_baptis']) : [];
        $file_surat_sidi = $sidi ? explode("#", $sidi['file_surat_sidi']) : [];
        return view('Pendeta.editdatajemaat', ['jemaat' => $jemaat, 'lampiran' => $lampiran, 'baptis' => $baptis, 'sidi' => $sidi, 'file_surat_baptis' => $file_surat_baptis, 'file_surat_sidi' => $file_surat_sidi, 'sektors' => $sektors,'idKeluarga'=>$idKeluarga]);
    }
    ...
    public function showsektoranggota()
    {
        ...
        return view('pendeta.sektorshowanggota', compact('sektors', 'jemaats', 'keluarga'));
    }
    ...
    function updatesektor(Request $request)
    {
        ...
        // Bandingkan data baru dengan data yang ada
        if ($newData == $currentData) {
            return redirect()->route('pendeta.Sektor')->with('warning', 'Tidak ada perubahan pada data Sektor!');
        }
    ...
    function formpelayan(Request $request)
    {
        ...
        return view('Pendeta.formdatapelayan', compact('jemaat'));
    }
    ...
    function updatedatapelayan(Request $request, $id)
{
    ...
    public function showrenungan()
    {
        ...
        return view('pendeta.renunganshow', compact('jadwal_ibadah', 'renungan'));
    }
    public function detailrenungan($id)
    {
        $renungan = Renungan::where("id", $id)->first();
        return view('pendeta.detailrenungan', compact( 'renungan'));
    }
    ...
    public function updaterenungan(Request $request, $id_user)
{
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('pendeta.renunganshow')->with('warning', 'Tidak ada perubahan pada data Renungan!');
    }
   ...
   if ($renunganPelayan) {
    ...
    public function showjadwal()
    {
        ...
        return view('pendeta.jadwal', compact('jadwal_ibadah', 'jadwal_pelayanan'));
    }
    ...
    public function storejadwal(Request $request)
{
    ...
    public function editjadwal($id)
    {
        ...
        return view('pendeta.editjadwal', ['jadwal_ibadah' => $jadwal_ibadah, 'lampiran' => $lampiran]);
    }
    public function updatejadwal(Request $request)
{
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('pendeta.jadwal')->with('warning', 'Tidak ada perubahan pada data Jadwal Ibadah!');
    }
    ...
    //     return view('pendeta.pelayanan', compact('pelayan', 'pelayans', 'jadwalPelayanan', 'jadwalIbadah'));
    // }
    public function showpelayanan(Request $request)
    {
        ...
        return view('pendeta.pelayanan', compact('pelayan', 'pelayans', 'jadwalPelayanan', 'jadwalIbadah', 'jumlahPelayanan'));
    }
    ...
    public function editpelayanan($id_jadwal_ibadah)
    {
        ...
        return view('Pendeta.editpelayanan', [
    ...
    public function updatepelayanan(Request $request, $id_jadwal_ibadah)
{
    ...
    public function createtata()
    {
        ...
        return view('pendeta.createtata', compact('jadwal_ibadahs'));
    }
    ...
    public function showprogramkerja()
    {
        ...
        return view('pendeta.programkerja', compact('program'));
    }
    public function showRAPB()
    {
        $program = Program::where('jenis_program', 'Rancangan Anggaran Penerimaan dan Belanja')->latest()->get();
        return view('pendeta.RAPB', compact('program'));
    }
    public function createprogram()
    {
        return view('pendeta.createprogram');
    }
    public function storeprogram(Request $request)
{
    ...
    if ($request->jenis_program == 'Rancangan Program Kerja') {
        return redirect()->route('pendeta.showprogramKerja')->with('success', 'Program Kerja berhasil ditambahkan!');
    } elseif ($request->jenis_program == 'Rancangan Anggaran Penerimaan dan Belanja') {
        return redirect()->route('pendeta.showRAPB')->with('success', 'Rancangan Anggaran Penerimaan dan Belanja berhasil ditambahkan!');
    }
}
    ...
    public function editprogram($id)
    {
        ...
        return view('pendeta.editprogram', ['program' => $program, 'lampiran' => $lampiran]);
    }
    public function updateprogram(Request $request, $id)
{
    ...
    if ($newData == $currentData) {
        if ($program->jenis_program == 'Rancangan Program Kerja') {
            return redirect()->route('pendeta.showprogramKerja')->with('warning', 'Tidak ada perubahan pada data Program!');
        } elseif ($program->jenis_program == 'Rancangan Anggaran Penerimaan dan Belanja') {
            return redirect()->route('pendeta.showRAPB')->with('warning', 'Tidak ada perubahan pada data Program!');
        }
    }
    ...
    // Penentuan arah redirect berdasarkan jenis_program yang baru saja dimasukkan
    if ($request->jenis_program == 'Rancangan Program Kerja') {
        return redirect()->route('pendeta.showprogramKerja')->with('success', 'Program Kerja berhasil diubah!');
    } elseif ($request->jenis_program == 'Rancangan Anggaran Penerimaan dan Belanja') {
        return redirect()->route('pendeta.showRAPB')->with('success', 'Rancangan Anggaran Penerimaan dan Belanja berhasil diubah!');
    }
}
    ...
    public function detailberita($id)
    {
        ...
        return view('Pendeta.detailberita', compact('berita_gereja'));
    }
    ...
    public function storeberita(Request $request, $id_user)
{
    ...
    // Redirect kembali dengan pesan sukses
    return redirect()->route('pendeta.berita')->with('success', 'Berita berhasil ditambahkan');
}
    ...
    public function editberita($id_user,$id)
    {
        $berita_gereja = DB::table('berita_gereja')
            ->where('id', $id)
            ->get();
        return view('pendeta.editberita', ['berita_gereja' => $berita_gereja]);
    }
    ...
    public function updateberita(Request $request, $id_user, $id)
{
    ...
    if ($newData == $currentData && !$request->hasFile('lampiran')) {
        return redirect()->route('pendeta.berita')->with('warning', 'Tidak ada perubahan pada data Berita!');
    }
   ...
   if ($beritaPelayan) {
    ...
    // Redirect kembali dengan pesan sukses
    return redirect()->route('pendeta.berita')->with('success', 'Berita berhasil diubah');
}
    ...
    public function pemasukanpersembahanibadah()
    {
        ...
        return view('Pendeta.dataPemasukanPersembahanIbadah', compact('pemasukan'));
    }
    ...
    public function pengeluaranpersembahanibadah()
    {
        ...
        return view('Pendeta.dataPengeluaranPersembahanIbadah', compact('pengeluaran'));
    }
    public function pembagianpersembahanibadah()
    {
        $kas = Kas::all();
        return view('Pendeta.dataPembagianPersembahanIbadah', compact('kas'));
    }
    public function detailpembagianpersembahanibadah($id)
    {
        ...
        return view('Pendeta.detailpembagianpersembahanibadah', compact('persembahan', 'kasList'));
    }
    ...
    public function pemasukanpersembahandiakonia()
    {
        ...
        return view('Pendeta.dataPemasukanPersembahanDiakonia', compact('pemasukan'));
    }
    public function pengeluaranpersembahandiakonia()
    {
        ...
        return view('Pendeta.dataPengeluaranPersembahanDiakonia', compact('pengeluaran'));
    }

    public function pemasukanpersembahankhusus()
    {
        $datakeuangan = PersembahanKhusus::all()->where('jenis_keuangan', 'Pemasukan');
        return view('Pendeta.dataPemasukanpersembahankhusus', compact('datakeuangan'));
    }
    public function pengeluaranpersembahankhusus()
    {
        $datakeuangan = PersembahanKhusus::all()->where('jenis_keuangan', 'Pengeluaran');
        return view('Pendeta.dataPengeluaranpersembahankhusus', compact('datakeuangan'));
    }
    ...
    public function pengeluarankas()
{
    ...
    ->get();
    return view('Pendeta.dataPengeluaranKas', compact('pengeluaran'));
}
...
// tambah keuangan
    ...
    function formkeuangan(Request $request)
    {
        ...
        return view('Pendeta.formtambahkeuangan', compact('keluarga', 'kas'));
    }
    ...
    function formkeuanganprocess(Request $request, $id_user)
    {
        ...
        return redirect()->route('pendeta.dataPemasukanPersembahanIbadah');
        ...
        return redirect()->route('pendeta.pengeluarankas');
            ...
            if ($request->jenis_keuangan == 'Pemasukan') {
                ...
                return redirect()->route('pendeta.dataPengeluaranPersembahanIbadah');
            }
            ...
            if ($request->jenis_keuangan == 'Pemasukan') {
                return redirect()->route('pendeta.datapemasukanpersembahanKhusus');
            } else {
                return redirect()->route('pendeta.datapengeluaranpersembahanKhusus');
            }
            ...
            if ($request->jenis_keuangan == 'Pemasukan') {
                return redirect()->route('pendeta.dataPemasukanPersembahanDiakonia');
            } else {
                return redirect()->route('pendeta.dataPengeluaranPersembahanDiakonia');
            }
            return redirect()->route('pendeta.datapersembahanUmum');
        }
    }
    ...
    public function ubahpengeluarankas($id_user,$id)
    {
        ...
        $kas  = Kas::all();
    return view('Pendeta.editdataPengeluaranKas', compact('pengeluaran', 'kas'));
    }
    ...
    public function updatepengeluarankas(Request $request, $id_user, $id)
{
    ...
    if (!$keuangan) {
        return redirect()->route('pendeta.pengeluarankas')->with('error', 'Data tidak ditemukan');
    }
    ...
    return redirect()->route('pendeta.pengeluarankas')->with('success', 'Data berhasil diperbarui');
}
...
public function ubahpemasukanpersembahanibadah($id_user, $id)
{
    ...
    return view('Pendeta.formubahpersembahanibadah', [
        'keuangan' => $keuangan,
        'kasList' => $kasList,
        'kases' => $kases
    ]);
...
public function updatepemasukanpersembahanibadah(Request $request, $id_user, $id)
{
    ...
    if (!$hasChanges) {
        return redirect()->route('pendeta.dataPemasukanPersembahanIbadah')->with('warning', 'Tidak ada perubahan pada data Pemasukan Persembahan Ibadah!');
    }

    return redirect()->route('pendeta.dataPemasukanPersembahanIbadah')->with('success', 'Data berhasil diperbarui');
}
    public function formkas($id_user)
    {
    return view('Pendeta.formtambahkas');
    }
    ...
    public function formkasprocess(Request $request, $id_user)
    {
        ...
        try {
            ...
            return redirect()->route('pendeta.dataPembagianPersembahanIbadah')->with('success', 'Data kas berhasil ditambahkan');
        } catch (\Exception $e) {
...
public function ubahpembagianpersentase($id_user)
    ...
    return view('Pendeta.formubahPersentase', [
        'kasList' => $kasList,
    ]);
    }
    ...
    public function updatepembagianpersentase(Request $request, $id_user)
    {
        try {
            ...
            return redirect()->route('pendeta.dataPembagianPersembahanIbadah')->with('success', 'Pembagian persentase berhasil diperbarui');
        } catch (\Exception $e) {
    ...
    public function ubahpengeluaranpersembahanibadah($id_user,$id)
    {
        ...
        return view('Pendeta.formubahpersembahanibadah', ['keuangan' => $keuangan]);
    }
    ...
    public function updatepengeluaranpersembahanibadah(Request $request, $id_user,$id)
{
    ...
    $keuangan = Keuangan::find($id);
    if (!$keuangan) {
        return redirect()->route('pendeta.dataPengeluaranPersembahanIbadah')->with('error', 'Data tidak ditemukan');
    }
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('pendeta.dataPengeluaranPersembahanIbadah')->with('warning', 'Tidak ada perubahan pada data Pengeluaran Persembahan Ibadah!');
    }
   ...
   if ($pelayanPersembahanIbadah) {
    ...
    return redirect()->route('pendeta.dataPengeluaranPersembahanIbadah')->with('success', 'Data berhasil diperbarui');
}
    ...
    {
        $keuangan = DB::table('keuangan')->where('id', $id)->get();
        return view('Pendeta.formubahpersembahandiakoni', ['keuangan' => $keuangan]);
    }
    ...
    public function updatepemasukanpersembahandiakonia(Request $request,$id_user, $id)
{
    ...
    $keuangan = Keuangan::find($id);
    if (!$keuangan) {
        return redirect()->route('pendeta.dataPemasukanPersembahanDiakonia')->with('error', 'Data tidak ditemukan');
    }
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('pendeta.dataPemasukanPersembahanDiakonia')->with('warning', 'Tidak ada perubahan pada data Pemasukan Persembahan Diakonia!');
    }
   ...
   if ($pelayanPersembahanIbadah) {
    ...
    return redirect()->route('pendeta.dataPemasukanPersembahanDiakonia')->with('success', 'Data berhasil diperbarui');
}
    ...
    public function updatepengeluaranpersembahandiakonia(Request $request, $id_user,$id)
{
    ...
    $keuangan = Keuangan::find($id);
    if (!$keuangan) {
        return redirect()->route('pendeta.dataPengeluaranPersembahanDiakonia')->with('error', 'Data tidak ditemukan');
    }
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('pendeta.dataPengeluaranPersembahanDiakonia')->with('warning', 'Tidak ada perubahan pada data Pengeluaran Persembahan Diakonia!');
    }
   ...
   if ($pelayanPersembahanIbadah) {
    ...
    return redirect()->route('pendeta.dataPengeluaranPersembahanDiakonia')->with('success', 'Data berhasil diperbarui');
}
    ...
    public function ubahpemasukanpersembahankhusus($id_user,$id)
    {
        ...
        return view('Pendeta.formubahpersembahankhusus', compact('keluarga', 'keuangan'));
    }
    ...
    public function updatepemasukanpersembahankhusus(Request $request, $id_user,$id)
{
    ...
    if (!$keuangan) {
        return redirect()->route('pendeta.datapemasukanpersembahanKhusus')->with('error', 'Data tidak ditemukan');
    }
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('pendeta.datapemasukanpersembahanKhusus')->with('warning', 'Tidak ada perubahan pada data Pemasukan Persembahan Khusus!');
    }
   ...
   if ($pelayanPersembahanKhusus) {
    ...
    return redirect()->route('pendeta.datapemasukanpersembahanKhusus')->with('success', 'Data berhasil diperbarui');
}
    ...
    public function updatepengeluaranpersembahankhusus(Request $request,$id_user, $id)
{
    ...
    $keuangan = PersembahanKhusus::find($id);
    if (!$keuangan) {
        return redirect()->route('pendeta.datapengeluaranpersembahanKhusus')->with('error', 'Data tidak ditemukan');
    }
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('pendeta.datapengeluaranpersembahanKhusus')->with('warning', 'Tidak ada perubahan pada data Pengeluaran Persembahan Khusus!');
    }
   ...
   if ($pelayanPersembahanKhusus) {
    ...
    return redirect()->route('pendeta.datapengeluaranpersembahanKhusus')->with('success', 'Data berhasil diperbarui');
}
    ...
    public function ubahpembagianpersembahanibadah($id_user,$id)
    {
        ...
        return view('Pendeta.formubahPembagianpersembahanibadah', compact('keuangan'));
    }
    ...
    public function updatepembagianpersembahanibadah( Request $request, $id_user, $id)
    {
        ...
        try {
            ...
            return redirect()->route('pendeta.dataPembagianPersembahanIbadah')->with('success', 'Data kas berhasil diupdate');
    ...
    public function profile($nik){
        ...
        $file_surat_baptis = $baptis ? explode("#", $baptis['file_surat_baptis']) : [];
        $file_surat_sidi = $sidi ? explode("#", $sidi['file_surat_sidi']) : [];
        return view('Pendeta.profile', ['jemaat'=> $jemaat,'lampiran'=> $lampiran, 'baptis'=>$baptis, 'sidi'=>$sidi, 'file_surat_baptis'=>$file_surat_baptis, 'file_surat_sidi'=>$file_surat_sidi, 'sektors' => $sektors]);
    }
