...
class PenatuaController extends Controller
{
    ...
    function detailstatistik($name){
        if($name == "Jumlah+Keluarga"){
            ...
            $jemaat = Jemaat::where('status_gereja', '!=', 'Aktif')->get();
            return view('Penatua.datajemaattidakaktif', [
            "jemaats" => $jemaat
        ]);
    ...
    function datakeluargatidakaktif(Request $request)
    {
        // Change this pagination if you want to increase pagination
        $keluarga = Keluarga::with('sektor')->where('status', '!=', 'Aktif')->get();
        return view('Penatua.datakeluargatidakaktif', [
            "keluargas" => $keluarga
        ]);
    }
    ...
    {
        $sektors = Sektor::get();
        return view("Penatua.formkeluarga", ['sektors' => $sektors]);
    }
    function formkeluargaprocess(Request $request)
    {
        ...
        return redirect()->route('penatua.datakeluarga')->with('success', 'Data Keluarga Berhasil Disimpan!');
    }
    ...
    public function keluargabaru($no_kk, $id)
    {
        ...
        return view('Penatua.formkeluargabaru', compact('keluarga', 'no_kk', 'jemaat'));
    }
    public function storekeluargabaru(Request $request, $no_kk,$id)
    {
        ...
        return redirect("penatua/data/keluarga/$request->no_kk")->with('success', 'Data Keluarga Berhasil Disimpan!');
    }
    public function editdatakeluarga(Request $request, $id)
    {
        ...
        $sektors = Sektor::get();
        $lampiran = explode("#", $keluarga['lampiran']);
        return view('Penatua.editdatakeluarga', ["keluarga" => $keluarga, 'lampiran' => $lampiran, 'sektors' => $sektors]);
    }
    public function update(Request $request, $id)
{
    ...
    if ($newData == $currentData) {
        return redirect()->route('penatua.datakeluarga')->with('warning', 'Tidak ada perubahan pada data Keluarga!');
    ...
    return redirect()->route('penatua.datakeluarga')->with('success', 'Data Keluarga Berhasil Diubah!');
}
    ...
    function datajemaatulangtahun()
{
    ...
    return view('Penatua.ulangtahun', [
    ...
    function formjemaat(Request $request, $idKeluarga)
    {
        ...
        return view('Penatua.formjemaat', ['keluarga' => $keluarga]);
    }
    ...
    public function formjemaatprocess(Request $request, $idKeluarga)
{
    ...
    if (!$jemaat->save()) {
        ...
        return redirect('/penatua/data/keluarga/' . $idKeluarga)->with('success', 'Data Jemaat Berhasil Disimpan!');
    }
}
    ...
    //     return view('Penatua.detailjemaat', ['jemaat'=> $jemaat,'lampiran'=> $lampiran, 'baptis'=>$baptis, 'sidi'=>$sidi, 'file_surat_baptis'=>$file_surat_baptis, 'file_surat_sidi'=>$file_surat_sidi]);
    // }
    ...
    function detailjemaat($nik)
    {
        ...
        return view('Penatua.detailjemaat', [
            'jemaat' => $jemaat,
            'lampiran' => $lampiran,
            'baptis' => $baptis,
            'sidi' => $sidi,
    ...
    function editdetailjemaat($nik)
    {
        ...
        $file_surat_baptis = $baptis ? explode("#", $baptis['file_surat_baptis']) : [];
        $file_surat_sidi = $sidi ? explode("#", $sidi['file_surat_sidi']) : [];
        return view('Penatua.editdatajemaat', ['jemaat' => $jemaat, 'lampiran' => $lampiran, 'baptis' => $baptis, 'sidi' => $sidi, 'file_surat_baptis' => $file_surat_baptis, 'file_surat_sidi' => $file_surat_sidi, 'sektors' => $sektors]);
    }
    ...
    function editdetailjemaat2($idKeluarga,$nik)
    {
        ...
        $file_surat_baptis = $baptis ? explode("#", $baptis['file_surat_baptis']) : [];
        $file_surat_sidi = $sidi ? explode("#", $sidi['file_surat_sidi']) : [];
        return view('Penatua.editdatajemaat', ['jemaat' => $jemaat, 'lampiran' => $lampiran, 'baptis' => $baptis, 'sidi' => $sidi, 'file_surat_baptis' => $file_surat_baptis, 'file_surat_sidi' => $file_surat_sidi, 'sektors' => $sektors,'idKeluarga'=>$idKeluarga]);
    }
    ...
    function updateJemaat(Request $request, $nik) {
        ...
        if (array_diff_assoc($newJemaatData, $jemaat->toArray()) == [] && 
    ...
    public function showsektoranggota()
    {
        ...
        return view('Penatua.sektorshowanggota', compact('sektors', 'jemaats', 'keluarga'));
    }

    public function createsektor()
    {
        return view('Penatua.createsektor');
    }
    public function storesektor(Request $request)
    {
        ...
        return redirect()->route('penatua.sektor')->with('success', 'Sektor berhasil ditambahkan!');
    }

    public function showsektor()
    {
        $sektors = Sektor::get();
        return view('Penatua.sektorshow', compact('sektors'));
    }
    ...
    { 
        $sektor = DB::table('sektor')
            ->where('id', $id)
            ->get();
        return view('Penatua.editsektor', ['sektor' => $sektor]);
    }
    ...
    function updatesektor(Request $request)
    {
        ...
        // Bandingkan data baru dengan data yang ada
        if ($newData == $currentData) {
            return redirect()->route('penatua.Sektor')->with('warning', 'Tidak ada perubahan pada data Sektor!');
        }
    
        // Update data sektor di database
        DB::table('sektor')->where('id', $id)->update($newData);
    
        return redirect()->route('penatua.Sektor')->with('success', 'Data Sektor Sudah Berhasil Diubah');
    }
    ...
    function formpelayan(Request $request)
    {
        ...
        return view('Penatua.formdatapelayan', compact('jemaat'));
    }
    function formpelayanprocess(Request $request)
{
    ...
    public function editdatapelayan($id)
    {
        ...
        return view('Penatua.editpelayan', [
            "pelayanas" => $pelayan
        ], compact('jemaat'));
    }
    function updatedatapelayan(Request $request, $id)
{
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect('penatua/pelayangereja')->with('warning', 'Tidak ada perubahan pada data Pelayan Gereja!');
    }
    ...
    return redirect('penatua/pelayangereja')->with('success', 'Data Pelayan Sudah Berhasil Diubah');
}
    ...
    public function showrenungan()
    {
        ...
        return view('Penatua.renunganshow', compact('jadwal_ibadah', 'renungan'));
    }
    public function detailrenungan($id)
    {
        $renungan = Renungan::where("id", $id)->first();
        return view('Penatua.detailrenungan', compact( 'renungan'));
    }
    ...
    public function updaterenungan(Request $request)
{
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('penatua.renunganshow')->with('warning', 'Tidak ada perubahan pada data Renungan!');
    }
    ...
    public function showjadwal()
    {
        ...
        return view('Penatua.jadwal', compact('jadwal_ibadah', 'jadwal_pelayanan'));
    }

    public function createjadwal()
    {
        return view('Penatua.createjadwal');
    }
    public function storejadwal(Request $request)
{
    ...
    return redirect()->route('penatua.jadwal')->with('success', 'Jadwal ibadah berhasil ditambahkan!');
}
    ...
    public function editjadwal($id)
    {
        ...
        return view('Penatua.editjadwal', ['jadwal_ibadah' => $jadwal_ibadah, 'lampiran' => $lampiran]);
    }
    public function updatejadwal(Request $request)
{
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('penatua.jadwal')->with('warning', 'Tidak ada perubahan pada data Jadwal Ibadah!');
    }
    ...
    //     return view('Penatua.pelayanan', compact('pelayan', 'pelayans', 'jadwalPelayanan', 'jadwalIbadah'));
    // }
    public function showpelayanan(Request $request)
    {
        $pelayans = PelayanGereja::with('jemaat')
        ...
        return view('Penatua.pelayanan', compact('pelayan', 'pelayans', 'jadwalPelayanan', 'jadwalIbadah', 'jumlahPelayanan'));
    }
    ...
    public function createpelayanan()
    {
         ...
         $pelayan_gereja = PelayanGereja::with('jemaat')
             ...
             ->get();
        return view('Penatua.createpelayanan', compact('pelayan_gereja'));
    }
    ...
    //         return redirect()->route('penatua.jadwal')->with('success','Jadwal pelayanan berhasil ditambahkan!');
    //     } else {
    ...
    function detailpelayanan(Request $request, $id_jadwal_ibadah)
    {
        ...
        return view('Penatua.detailpelayanan', ['status_pelayanan' => $status_pelayanan, 'persembahan' => $persembahan, 'penerima_tamu' => $penerima_tamu, 'results' => $results, 'results_persembahan' => $results_persembahan, 'results_penerima_tamu' => $results_penerima_tamu]);
    }
    ...
    public function editpelayanan($id_jadwal_ibadah)
    {
        ...
        return view('Penatua.editpelayanan', [
    ...
    //      // Pass both arrays to the view
    //      return view('Penatua.editpelayanan', ['pelayan_gereja' => $pelayan_gereja, 'status_pelayanan' => $status_pelayanan,'results' => $results]);
    //             // return view('Penatua.editpelayanan', compact('pelayan_gereja'));
    // }
    ...
    public function updatepelayanan(Request $request, $id_jadwal_ibadah)
{
    ...
    return redirect("penatua/jadwal/pelayanan/$id_jadwal_ibadah")->with('success', 'Data pelayanan berhasil diperbarui.');
}
    ...
    //     return redirect()->route('penatua.detailpelayanan', ['id' => $id])->with('success', 'Jadwal Pelayanan Sudah Berhasil Diubah');
    // }
    ...
    function detailtataibadah()
    {
        ...
        $renungan = Renungan::latest()->take(10)->get();
        return view('Penatua.detailibadah', compact('jadwal_ibadah', 'tata_ibadah', 'renungan'));
    }
    public function createtata()
    {

        $jadwal_ibadahs = jadwal_ibadah::whereNull('tata_ibadah')->latest()->get();
        return view('Penatua.createtata', compact('jadwal_ibadahs'));
    }
    function formibadah(Request $request)
    {

        return view("Penatua.tambahibadah");
    }
    ...
    function tatastore(Request $request)
    {
        ...
        return redirect()->route('penatua.detailibadah')->with('success', 'Tata Ibadah Sudah Berhasil Ditambahkan');
    }
    public function edittataibadah($id)
    {
        $tata_ibadah = DB::table('tata_ibadah')
            ->where('id', $id)
            ->get();
        return view('Penatua.edittataibadah', ['tata_ibadah' => $tata_ibadah]);
    }
    function updatetataibadah(Request $request)
    {
        ...
        return redirect()->route('penatua.detailibadah')->with('success', 'Tata Ibadah Sudah Berhasil Diubah');
    }
    //PROGRAM
    ...
    public function showprogramkerja()
    {
        ...
        return view('Penatua.programkerja', compact('program'));
    }
    public function showRAPB()
    {
        $program = Program::where('jenis_program', 'Rancangan Anggaran Penerimaan dan Belanja')->latest()->get();
        return view('Penatua.RAPB', compact('program'));
    }
    public function createprogram()
    {
        return view('Penatua.createprogram');
    }
    public function storeprogram(Request $request)
{
    ...
    if ($request->jenis_program == 'Rancangan Program Kerja') {
        return redirect()->route('penatua.showprogramKerja')->with('success', 'Program Kerja berhasil ditambahkan!');
    } elseif ($request->jenis_program == 'Rancangan Anggaran Penerimaan dan Belanja') {
        return redirect()->route('penatua.showRAPB')->with('success', 'Rancangan Anggaran Penerimaan dan Belanja berhasil ditambahkan!');
    }
}
    ...
    public function editprogram($id)
    {
        ...
        return view('Penatua.editprogram', ['program' => $program, 'lampiran' => $lampiran]);
    }
    public function updateprogram(Request $request, $id)
{
    ...
    if ($newData == $currentData) {
        if ($program->jenis_program == 'Rancangan Program Kerja') {
            return redirect()->route('penatua.showprogramKerja')->with('warning', 'Tidak ada perubahan pada data Program!');
        } elseif ($program->jenis_program == 'Rancangan Anggaran Penerimaan dan Belanja') {
            return redirect()->route('penatua.showRAPB')->with('warning', 'Tidak ada perubahan pada data Program!');
        }
    }
    ...
    // Penentuan arah redirect berdasarkan jenis_program yang baru saja dimasukkan
    if ($request->jenis_program == 'Rancangan Program Kerja') {
        return redirect()->route('penatua.showprogramKerja')->with('success', 'Program Kerja berhasil diubah!');
    } elseif ($request->jenis_program == 'Rancangan Anggaran Penerimaan dan Belanja') {
        return redirect()->route('penatua.showRAPB')->with('success', 'Rancangan Anggaran Penerimaan dan Belanja berhasil diubah!');
    }
}
    ...
    public function showberita()
    {
        ...
        return view('Penatua.databerita', compact('berita_gereja'));
    }
    ...
    public function detailberita($id)
    {
        ...
        return view('Penatua.detailberita', compact('berita_gereja'));
    }
    public function createberita()
    {
        return view('Penatua.createberita');
    }
    ...
    public function storeberita(Request $request, $id_user)
{
    ...
    // Redirect kembali dengan pesan sukses
    return redirect()->route('penatua.berita')->with('success', 'Berita berhasil ditambahkan');
}
    ...
    public function editberita($id_user,$id)
    {
        $berita_gereja = DB::table('berita_gereja')
            ->where('id', $id)
            ->get();
        return view('Penatua.editberita', ['berita_gereja' => $berita_gereja]);
    }
    ...
    public function updateberita(Request $request, $id_user, $id)
{
    ...
    if ($newData == $currentData && !$request->hasFile('lampiran')) {
        return redirect()->route('penatua.berita')->with('warning', 'Tidak ada perubahan pada data Berita!');
    }
   ...
   if ($beritaPelayan) {
    ...
    // Redirect kembali dengan pesan sukses
    return redirect()->route('penatua.berita')->with('success', 'Berita berhasil diubah');
}
    ...
    public function pemasukanpersembahanibadah()
    {
        ...
        return view('Penatua.dataPemasukanPersembahanIbadah', compact('pemasukan'));
    }
    ...
    public function pengeluaranpersembahanibadah()
    {
        ...
        return view('Penatua.dataPengeluaranPersembahanIbadah', compact('pengeluaran'));
    }
    public function pembagianpersembahanibadah()
    {
        $kas = Kas::all();
        return view('Penatua.dataPembagianPersembahanIbadah', compact('kas'));
    }
    public function detailpembagianpersembahanibadah($id)
    {
        ...
        return view('Penatua.detailpembagianpersembahanibadah', compact('persembahan', 'kasList'));
    }
    ...
    public function pemasukanpersembahandiakonia()
    {
        ...
        return view('Penatua.dataPemasukanPersembahanDiakonia', compact('pemasukan'));
    }
    public function pengeluaranpersembahandiakonia()
    {
        ...
        return view('Penatua.dataPengeluaranPersembahanDiakonia', compact('pengeluaran'));
    }

    public function pemasukanpersembahankhusus()
    {
        $datakeuangan = PersembahanKhusus::all()->where('jenis_keuangan', 'Pemasukan');
        return view('Penatua.dataPemasukanpersembahankhusus', compact('datakeuangan'));
    }
    public function pengeluaranpersembahankhusus()
    {
        $datakeuangan = PersembahanKhusus::all()->where('jenis_keuangan', 'Pengeluaran');
        return view('Penatua.dataPengeluaranpersembahankhusus', compact('datakeuangan'));
    }
    ...
    public function pengeluarankas()
{
    ...
    ->get();
    return view('Penatua.dataPengeluaranKas', compact('pengeluaran'));
}
...
// tambah keuangan
    ...
    function formkeuangan(Request $request)
    {
        ...
        return view('Penatua.formtambahkeuangan', compact('keluarga', 'kas'));
    }
    ...
    function formkeuanganprocess(Request $request, $id_user)
    {
        ...
        return redirect()->route('penatua.dataPemasukanPersembahanIbadah');
        ...
        return redirect()->route('penatua.pengeluarankas');
            ...
            if ($request->jenis_keuangan == 'Pemasukan') {
                ...
                return redirect()->route('penatua.dataPengeluaranPersembahanIbadah');
            }
            ...
            if ($request->jenis_keuangan == 'Pemasukan') {
                return redirect()->route('penatua.datapemasukanpersembahanKhusus');
            } else {
                return redirect()->route('penatua.datapengeluaranpersembahanKhusus');
            }
            ...
            if ($request->jenis_keuangan == 'Pemasukan') {
                return redirect()->route('penatua.dataPemasukanPersembahanDiakonia');
            } else {
                return redirect()->route('penatua.dataPengeluaranPersembahanDiakonia');
            }
            return redirect()->route('penatua.datapersembahanUmum');
        }
    }
    ...
    public function ubahpengeluarankas($id_user,$id)
    {
        ...
        $kas  = Kas::all();
    return view('Penatua.editdataPengeluaranKas', compact('pengeluaran', 'kas'));
    }
    ...
    public function updatepengeluarankas(Request $request, $id_user, $id)
{
    ...
    if (!$keuangan) {
        return redirect()->route('penatua.pengeluarankas')->with('error', 'Data tidak ditemukan');
    }
    ...
    return redirect()->route('penatua.pengeluarankas')->with('success', 'Data berhasil diperbarui');
}
...
public function ubahpemasukanpersembahanibadah($id_user, $id)
{
    ...
    return view('Penatua.formubahpersembahanibadah', [
        'keuangan' => $keuangan,
        'kasList' => $kasList,
        'kases' => $kases
    ]);
...
public function updatepemasukanpersembahanibadah(Request $request, $id_user, $id)
{
    ...
    if (!$hasChanges) {
        return redirect()->route('penatua.dataPemasukanPersembahanIbadah')->with('warning', 'Tidak ada perubahan pada data Pemasukan Persembahan Ibadah!');
    }

    return redirect()->route('penatua.dataPemasukanPersembahanIbadah')->with('success', 'Data berhasil diperbarui');
}
    public function formkas($id_user)
    {
    return view('Penatua.formtambahkas');
    }
    ...
    public function formkasprocess(Request $request, $id_user)
    {
        ...
        try {
            ...
            return redirect()->route('penatua.dataPembagianPersembahanIbadah')->with('success', 'Data kas berhasil ditambahkan');
        } catch (\Exception $e) {
...
public function ubahpembagianpersentase($id_user)
    ...
    return view('Penatua.formubahPersentase', [
        'kasList' => $kasList,
    ]);
    }
    ...
    public function updatepembagianpersentase(Request $request, $id_user)
    {
        try {
            ...
            return redirect()->route('penatua.dataPembagianPersembahanIbadah')->with('success', 'Pembagian persentase berhasil diperbarui');
        } catch (\Exception $e) {
    ...
    public function ubahpengeluaranpersembahanibadah($id_user,$id)
    {
        ...
        return view('Penatua.formubahpersembahanibadah', ['keuangan' => $keuangan]);
    }
    ...
    public function updatepengeluaranpersembahanibadah(Request $request, $id_user,$id)
{
    ...
    $keuangan = Keuangan::find($id);
    if (!$keuangan) {
        return redirect()->route('penatua.dataPengeluaranPersembahanIbadah')->with('error', 'Data tidak ditemukan');
    }
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('penatua.dataPengeluaranPersembahanIbadah')->with('warning', 'Tidak ada perubahan pada data Pengeluaran Persembahan Ibadah!');
    }
   ...
   if ($pelayanPersembahanIbadah) {
    ...
    return redirect()->route('penatua.dataPengeluaranPersembahanIbadah')->with('success', 'Data berhasil diperbarui');
}
    ...
    {
        $keuangan = DB::table('keuangan')->where('id', $id)->get();
        return view('Penatua.formubahpersembahandiakoni', ['keuangan' => $keuangan]);
    }
    ...
    public function updatepemasukanpersembahandiakonia(Request $request,$id_user, $id)
{
    ...
    $keuangan = Keuangan::find($id);
    if (!$keuangan) {
        return redirect()->route('penatua.dataPemasukanPersembahanDiakonia')->with('error', 'Data tidak ditemukan');
    }
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('penatua.dataPemasukanPersembahanDiakonia')->with('warning', 'Tidak ada perubahan pada data Pemasukan Persembahan Diakonia!');
    }
   ...
   if ($pelayanPersembahanIbadah) {
    ...
    return redirect()->route('penatua.dataPemasukanPersembahanDiakonia')->with('success', 'Data berhasil diperbarui');
}
    ...
    public function updatepengeluaranpersembahandiakonia(Request $request, $id_user,$id)
{
    ...
    $keuangan = Keuangan::find($id);
    if (!$keuangan) {
        return redirect()->route('penatua.dataPengeluaranPersembahanDiakonia')->with('error', 'Data tidak ditemukan');
    }
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('penatua.dataPengeluaranPersembahanDiakonia')->with('warning', 'Tidak ada perubahan pada data Pengeluaran Persembahan Diakonia!');
    }
   ...
   if ($pelayanPersembahanIbadah) {
    ...
    return redirect()->route('penatua.dataPengeluaranPersembahanDiakonia')->with('success', 'Data berhasil diperbarui');
}
    ...
    public function ubahpemasukanpersembahankhusus($id_user,$id)
    {
        ...
        return view('Penatua.formubahpersembahankhusus', compact('keluarga', 'keuangan'));
    }
    ...
    public function updatepemasukanpersembahankhusus(Request $request, $id_user,$id)
{
    ...
    if (!$keuangan) {
        return redirect()->route('penatua.datapemasukanpersembahanKhusus')->with('error', 'Data tidak ditemukan');
    }
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('penatua.datapemasukanpersembahanKhusus')->with('warning', 'Tidak ada perubahan pada data Pemasukan Persembahan Khusus!');
    }
   ...
   if ($pelayanPersembahanKhusus) {
    ...
    return redirect()->route('penatua.datapemasukanpersembahanKhusus')->with('success', 'Data berhasil diperbarui');
}
    ...
    public function updatepengeluaranpersembahankhusus(Request $request,$id_user, $id)
{
    ...
    $keuangan = PersembahanKhusus::find($id);
    if (!$keuangan) {
        return redirect()->route('penatua.datapengeluaranpersembahanKhusus')->with('error', 'Data tidak ditemukan');
    }
    ...
    // Bandingkan data baru dengan data yang ada
    if ($newData == $currentData) {
        return redirect()->route('penatua.datapengeluaranpersembahanKhusus')->with('warning', 'Tidak ada perubahan pada data Pengeluaran Persembahan Khusus!');
    }
   ...
   if ($pelayanPersembahanKhusus) {
    ...
    return redirect()->route('penatua.datapengeluaranpersembahanKhusus')->with('success', 'Data berhasil diperbarui');
}
    ...
    public function ubahpembagianpersembahanibadah($id_user,$id)
    {
        ...
        return view('Penatua.formubahPembagianpersembahanibadah', compact('keuangan'));
    }
    ...
    public function updatepembagianpersembahanibadah( Request $request, $id_user, $id)
    {
        ...
        try {
            ...
            return redirect()->route('penatua.dataPembagianPersembahanIbadah')->with('success', 'Data kas berhasil diupdate');
    ...
    public function profile($nik){
        ...
        $file_surat_baptis = $baptis ? explode("#", $baptis['file_surat_baptis']) : [];
        $file_surat_sidi = $sidi ? explode("#", $sidi['file_surat_sidi']) : [];
        return view('Penatua.profile', ['jemaat'=> $jemaat,'lampiran'=> $lampiran, 'baptis'=>$baptis, 'sidi'=>$sidi, 'file_surat_baptis'=>$file_surat_baptis, 'file_surat_sidi'=>$file_surat_sidi, 'sektors' => $sektors]);
    }
