...
<div class="col-12 p-3 bg-white shadow rounded">
    ...
    @foreach ($keuangan as $datakeuangan)
        <form class="mt-3"
            action="@if ($navbars == StaticVariable::$navbarPengurusHarian) /pengurusharian/data/keuangan/update/{{ $datakeuangan->id }}
@elseif ($navbars == StaticVariable::$navbarPendeta)
    /pendeta/data/keuangan/update/{{ $datakeuangan->id }} @endif"
            ...
            <div class="row">
                <div class="form-group col-12 col-md-6 mt-3">
                    ...
                    <select name="kategori" id="kategori" class="form-control" required>
                        ...
                        <option value="Tahun Gerejawi dan Ulang Tahun Gereja">Tahun Gerejawi dan Ulang Tahun Gereja
                        </option>
                ...
                <div class="form-group col-12 col-md-6 mt-3">
                    ...
                    <input type="text" name="keterangan" id="keterangan" class="form-control"
                        value=" {{ $datakeuangan->keterangan }}" required>
                </div>
                <div class="form-group col-12 col-md-6 mt-3">
                    <label for="jenis_keuangan">Jenis Tranksaksi</label>
                    <select name="jenis_keuangan" id="jenis_keuangan" class="form-control" required>
                ...
                <div class="form-group col-12 col-md-6 mt-3">
                    ...
                    <input type="date" name="tanggal" id="tanggal" class="form-control"
                        value="{{ $datakeuangan->tanggal }}" required>
                </div>
                <div class="form-group col-12 col-md-6 mt-3">
