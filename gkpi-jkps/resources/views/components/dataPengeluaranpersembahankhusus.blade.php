                ...
                <tbody name="data" id="data">
                    @foreach ($datakeuangan as $keuangan)
                        ...
                        <tr>
                            ...
                            <td class="td1">{{ $keuangan->kategori }}</td>
                            <td class="td1">{{ $keuangan->keluarga->nama_keluarga }}</td>
                                ...
                                <div class="d-flex gap-3 flex-column flex-md-row">
                                    @if ($navbars == StaticVariable::$navbarPengurusHarian)
                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit Keuangan"
                                            href="/pengurusharian/{{ StaticVariable::$user->nik }}/data/persembahankhusus/pengeluaran/edit/{{ $keuangan->id }}"
                                            class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                    @elseif($navbars == StaticVariable::$navbarPendeta)
                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit Keuangan"
                                            href="/pendeta/{{ StaticVariable::$user->nik }}/data/persembahankhusus/pengeluaran/edit/{{ $keuangan->id }}"
                                            class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                    @endif
                                </div>
                            </td>
