                    ...
                    <table class="table table-bordered" id="list">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Lampiran Tata Ibadah</th>
                        ...
                        <tbody>
                            @foreach ($tata_ibadah as $war)
                                <tr>
                                    <td>{{ $war['nama'] }}</td>
                                    <td>{{ $war['tanggal'] }}</td>
                                    <td><a target="_BLANK" href="{{ $war['lampiran'] }}">Unduh File</a></td>
                                    <td style="">
                                        <div class="d-flex gap-3 flex-column flex-md-row">
                                            <a href="/tatausaha/tataibadah/{{ $war->id }}" data-toggle="tooltip"
                                                data-placement="bottom" title="Edit Data Pelayan"
