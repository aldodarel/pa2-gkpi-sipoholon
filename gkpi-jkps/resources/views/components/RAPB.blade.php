...
<div class="col-9">
    <h2 class="text">Daftar Rancangan Anggaran Penerimaan dan Belanja</h2>
</div>
...
<script>
    $(document).ready(function() {
        $('#list').DataTable({
            ...
            "language": {
                "lengthMenu": "Tampilkan _MENU_ Data RAPB per halaman",
                "zeroRecords": "Maaf, tidak dapat menemukan apapun",
                "info": "Menampilkan halaman _PAGE_ dari _PAGES_ halaman",
                "infoEmpty": "Tidak ada RAPB yang dapat ditampilkan",
                "infoFiltered": "(dari _MAX_ total RAPB)",
                "search": "Cari :",
                "paginate": {
                    "first": "Pertama",
                    "last": "Terakhir",
